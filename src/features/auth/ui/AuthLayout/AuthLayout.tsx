...
import { ThemeLanguageControls } from '../../../../app/layout/ThemeLanguageControls';
import { useI18n } from '../../../../i18n';
import { Seam } from '../../../../shared/ui/Icon';
    ...
    <div className="auth-wrap">
      <div className="auth-brandside">
        ...
        <div className="b-top">
          ...
          <span className={`brand__tag ${styles.tag}`}>{t('tap_hero')}</span>
        ...
        <div className={styles.poweredBy}>{t('powered_by')}</div>
      </div>
